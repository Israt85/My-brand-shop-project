...
const Team = () => {
    return (
       <div className='w-full mt-6 mx-auto h-auto md:h-96 '>
        <h2 className='text-center text-orange-700 font-bold text-3xl py-6'>Our Valuable Clients</h2>
         ...
         <div className=" gap-4 grid grid-cols-1 md:grid-cols-3">
            ...
            <figure className="px-32">
                        <img src={team1} alt="Shoes" className=" md:relative md:rounded-full h-20 w-20 " />
                    </figure>
                <div className=" p-4 md:absolute md:-mt-10 card md:w-1/3 shadow-xl">
                    
                    <div className=" h-60 md:pt-10 items-center text-center">
            ...
            <div>
            <figure className="px-32">
                        <img src={team2} alt="Shoes" className=" md:relative md:rounded-full h-20 w-20 " />
                    </figure>
                <div className=" p-4 md:absolute md:-mt-10 card md:w-1/3 shadow-xl">
            ...
            <div>
            <figure className="px-32">
                        <img src={team3} alt="Shoes" className=" md:relative md:rounded-full h-20 w-20 " />
                    </figure>
                <div className=" p-4 md:absolute md:-mt-10 card md:w-1/3 shadow-xl">
